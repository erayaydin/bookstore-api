...
@section('page.title', 'Yazarlar')

@push("breadcrumbs")
    <a href="{{ route('author.index') }}" class="breadcrumb--active">Yazarlar</a>
@endpush
...
@section('page.contents')
    <div class="intro-y mt-10 flex flex-wrap sm:flex-no-wrap justify-between items-center">
        ...
        <a href="{{ route('author.create') }}" class="button text-white bg-theme-1 shadow-md">
            Yeni Yazar Ekle
        </a>
    </div>
            ...
            <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
                <table class="table table-report -mt-2">
                    ...
                    <tr>
                        ...
                        <th class="text-center whitespace-no-wrap" style="width: 50%;">Yazar Adı</th>
                    ...
                    @foreach($authors as $author)
                        <tr class="intro-x">
                            ...
                            <td class="text-center">{{$author->uuid}}</td>
                            <td class="table-report__action">
                                <div class="flex justify-center items-center">
                                    <a class="flex items-center mr-3" href="{{ route('author.edit', ['author' => $author]) }}"> <i data-feather="check-square" class="w-4 h-4 mr-1"></i> Güncelle </a>
                                    <a class="flex items-center text-theme-6 delete" style="cursor: pointer;" data-action="{{ route('author.destroy', ['author' => $author->id]) }}" data-toggle="modal" data-target="#delete-confirmation-modal"> <i data-feather="trash-2" class="w-4 h-4 mr-1"></i> Sil </a>
                                </div>
                            </td>
                        </tr>
                    @endforeach
